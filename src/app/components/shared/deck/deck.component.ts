...
export class DeckComponent implements OnInit {
  constructor(private route: Router, @Inject(MAT_DIALOG_DATA) public data: {deck: any}, private dialogRef: MatDialogRef<DeckComponent>, private cardService: CardService) {}
  ...
  deleteDeck(){
    this.cardService.deleteDeck(this.data.deck.id).subscribe(
      (res=>{
        Swal.fire({
          icon: "success",
          title: "Deck apagado!",
